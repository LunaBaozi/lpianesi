...
**03.02.2026 I completed this blog post over the course of several months (writing paralysis again!) but I choose to display the date I wrote most of its content.**
...
![Two wolves meme](/lpianesi/images/wolves.jpeg)
...
- *Giving that I could use LLMs a lot, how much should I use them though?* There is no intuitive boudary here, and defining an objective one is almost an impossible task. It should be the work of people writing regulations and guidelines, which are much needed at this point. Personally, I am trying to use LLMs as coding assistants, content summarization tools, job interview simulators, deliberately forcing myself to go through the struggle that is my PhD everyday. 
- *But that's tricky, because it's tied to my feeling that I need to struggle to make something worth it. So how much should I struggle?* Another question with no single answer. My personal compass has evolved into pointing me to keep going or give up according to how much I'm psychologically suffering the situation. Is it unbearable and has it been unbearable for more than I can tolerate? Give in and get help. Am I just a bit lazier than usual and I have no motivation? Keep going and try to push yourself.
- *But what does it mean to struggle in science? How much is it okay to struggle when thinking about science? What is an okay type of struggle?* The act of critically thinking about a subject and formulating informed opinions on it is objectively demanding in terms of mental energies. So at the very basis of doing science there is struggle, or we can call it effort. But sometimes this "effort" turns into spending so much of yourself that you feel empty. That is a clear sign that you overstepped your own boundary. Ideally, one should reconsider the direction of the path they're walking much earlier than that, albeit not always being easy.  

I think there is an important consideration to keep in mind in this case: our activity as scientists is inevitably and costantly intertwined with the activity of other scientists: think about having discussions with your colleagues over a cup of coffee, or group meetings, or presenting your work at conferences, or peer-reviewing other people's work. Sometimes, it happens that we find ourselves to do science alone; it can happen for many reasons, and for a variable amount of time. Personally, I will try my best to prioritise exercising the muscle of discussion with others, lest quickly running on the path of burn-out again.
...
![trapped-creature](/lpianesi/images/bleah.jpeg){: width="250" }

*Visual testimony of cockroach in shoe, shoe in trash bag, trash bag in bin, bin under 6L water bottle. Huge shoutout to my flatmate who helped me catch them at 3 a.m. in the morning.*
